...
const mapMotoData = (data) => {
  ...
  return {
    ...
    autonomy: data.autonomia ?? data.range ?? "",
...
const MotoDetail = () => {
  ...
  useEffect(() => {
    if (moto?.titulo) {
      ...
      const description = moto.heroDescription || moto.descripcion;
      setMetaDescription(description);
      setMetaProperty("og:title", moto.titulo);
      setMetaProperty("og:description", description);
      setMetaProperty("og:image", moto.heroImage || moto.imagen);
